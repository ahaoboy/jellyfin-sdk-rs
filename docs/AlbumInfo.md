...
**album_artists** | Option<**Vec<String>**> | Gets or sets the album artist. | [optional]
**artist_provider_ids** | Option<**std::collections::HashMap<String, String>**> | Gets or sets the artist provider ids. | [optional]
**song_infos** | Option<[**Vec<models::SongInfo>**](SongInfo.md)> |  | [optional]
