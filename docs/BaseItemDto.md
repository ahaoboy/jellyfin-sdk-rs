...
**external_urls** | Option<[**Vec<models::ExternalUrl>**](ExternalUrl.md)> | Gets or sets the external urls. | [optional]
**media_sources** | Option<[**Vec<models::MediaSourceInfo>**](MediaSourceInfo.md)> | Gets or sets the media versions. | [optional]
...
**play_access** | Option<[**models::PlayAccess**](PlayAccess.md)> |  | [optional]
...
**remote_trailers** | Option<[**Vec<models::MediaUrl>**](MediaUrl.md)> | Gets or sets the trailer urls. | [optional]
...
**r#type** | Option<[**models::BaseItemKind**](BaseItemKind.md)> |  | [optional]
**people** | Option<[**Vec<models::BaseItemPerson>**](BaseItemPerson.md)> | Gets or sets the people. | [optional]
**studios** | Option<[**Vec<models::NameGuidPair>**](NameGuidPair.md)> | Gets or sets the studios. | [optional]
**genre_items** | Option<[**Vec<models::NameGuidPair>**](NameGuidPair.md)> |  | [optional]
...
**user_data** | Option<[**models::UserItemDataDto**](UserItemDataDto.md)> |  | [optional]
...
**air_days** | Option<[**Vec<models::DayOfWeek>**](DayOfWeek.md)> | Gets or sets the air days. | [optional]
...
**artist_items** | Option<[**Vec<models::NameGuidPair>**](NameGuidPair.md)> | Gets or sets the artist items. | [optional]
...
**album_artists** | Option<[**Vec<models::NameGuidPair>**](NameGuidPair.md)> | Gets or sets the album artists. | [optional]
**season_name** | Option<**String**> | Gets or sets the name of the season. | [optional]
**media_streams** | Option<[**Vec<models::MediaStream>**](MediaStream.md)> | Gets or sets the media streams. | [optional]
...
**image_blur_hashes** | Option<[**models::BaseItemDtoImageBlurHashes**](BaseItemDto_ImageBlurHashes.md)> |  | [optional]
...
**chapters** | Option<[**Vec<models::ChapterInfo>**](ChapterInfo.md)> | Gets or sets the chapters. | [optional]
**location_type** | Option<[**models::LocationType**](LocationType.md)> |  | [optional]
...
**locked_fields** | Option<[**Vec<models::MetadataField>**](MetadataField.md)> | Gets or sets the locked fields. | [optional]
...
**image_orientation** | Option<[**models::ImageOrientation**](ImageOrientation.md)> |  | [optional]
...
**channel_type** | Option<[**models::ChannelType**](ChannelType.md)> |  | [optional]
**audio** | Option<[**models::ProgramAudio**](ProgramAudio.md)> |  | [optional]
...
**current_program** | Option<[**models::BaseItemDto**](BaseItemDto.md)> |  | [optional]
