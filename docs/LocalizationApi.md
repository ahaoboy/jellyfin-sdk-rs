...
> Vec<models::CountryInfo> get_countries()
...
[**Vec<models::CountryInfo>**](CountryInfo.md)
...
> Vec<models::CultureDto> get_cultures()
Gets known cultures.
...
[**Vec<models::CultureDto>**](CultureDto.md)
...
> Vec<models::LocalizationOption> get_localization_options()
...
> Vec<models::ParentalRating> get_parental_ratings()
...
[**Vec<models::ParentalRating>**](ParentalRating.md)
