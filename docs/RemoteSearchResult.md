...
**album_artist** | Option<[**models::RemoteSearchResult**](RemoteSearchResult.md)> |  | [optional]
**artists** | Option<[**Vec<models::RemoteSearchResult>**](RemoteSearchResult.md)> |  | [optional]
