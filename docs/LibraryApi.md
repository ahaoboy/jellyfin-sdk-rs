...
> models::BaseItemDtoQueryResult get_critic_reviews(item_id)
...
> models::AllThemeMediaResult get_theme_media(item_id, user_id, inherit_from_parent)
...
> models::ThemeMediaResult get_theme_songs(item_id, user_id, inherit_from_parent)
...
> models::ThemeMediaResult get_theme_videos(item_id, user_id, inherit_from_parent)
