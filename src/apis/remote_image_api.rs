...
pub async fn get_remote_image_providers(
    configuration: &configuration::Configuration,
    item_id: &str,
) -> Result<Vec<models::ImageProviderInfo>, Error<GetRemoteImageProvidersError>> {
    let local_var_configuration = configuration;
...
pub async fn get_remote_images(
    configuration: &configuration::Configuration,
    item_id: &str,
    r#type: Option<models::ImageType>,
    start_index: Option<i32>,
    limit: Option<i32>,
    provider_name: Option<&str>,
    include_all_languages: Option<bool>,
) -> Result<models::RemoteImageResult, Error<GetRemoteImagesError>> {
    let local_var_configuration = configuration;
