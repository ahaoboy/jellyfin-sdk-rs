...
) -> Result<models::PackageInfo, Error<GetPackageInfoError>> {
    let local_var_configuration = configuration;
...
pub async fn get_packages(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::PackageInfo>, Error<GetPackagesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_repositories(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::RepositoryInfo>, Error<GetRepositoriesError>> {
    let local_var_configuration = configuration;
...
pub async fn set_repositories(
    configuration: &configuration::Configuration,
    repository_info: Vec<models::RepositoryInfo>,
