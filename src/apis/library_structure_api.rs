...
pub async fn add_media_path(
    ...
    media_path_dto: models::MediaPathDto,
...
pub async fn add_virtual_folder(
    configuration: &configuration::Configuration,
    name: Option<&str>,
    collection_type: Option<models::CollectionTypeOptions>,
    paths: Option<Vec<String>>,
    refresh_library: Option<bool>,
    add_virtual_folder_dto: Option<models::AddVirtualFolderDto>,
...
pub async fn get_virtual_folders(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::VirtualFolderInfo>, Error<GetVirtualFoldersError>> {
    let local_var_configuration = configuration;
...
pub async fn update_library_options(
    configuration: &configuration::Configuration,
    update_library_options_dto: Option<models::UpdateLibraryOptionsDto>,
...
pub async fn update_media_path(
    configuration: &configuration::Configuration,
    update_media_path_request_dto: models::UpdateMediaPathRequestDto,
