...
) -> Result<models::DefaultDirectoryBrowserInfoDto, Error<GetDefaultDirectoryBrowserError>> {
...
) -> Result<Vec<models::FileSystemEntryInfo>, Error<GetDirectoryContentsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_drives(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::FileSystemEntryInfo>, Error<GetDrivesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_network_shares(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::FileSystemEntryInfo>, Error<GetNetworkSharesError>> {
    let local_var_configuration = configuration;
...
pub async fn validate_path(
    configuration: &configuration::Configuration,
    validate_path_dto: models::ValidatePathDto,
