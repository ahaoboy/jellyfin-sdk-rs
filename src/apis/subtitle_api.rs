...
pub async fn get_fallback_font_list(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::FontFile>, Error<GetFallbackFontListError>> {
    let local_var_configuration = configuration;
...
) -> Result<Vec<models::RemoteSubtitleInfo>, Error<SearchRemoteSubtitlesError>> {
    let local_var_configuration = configuration;
...
pub async fn upload_subtitle(
    configuration: &configuration::Configuration,
    item_id: &str,
    upload_subtitle_dto: models::UploadSubtitleDto,
