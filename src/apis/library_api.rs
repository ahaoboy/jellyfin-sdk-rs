...
pub async fn get_ancestors(
    ...
    item_id: &str,
    user_id: Option<&str>,
) -> Result<Vec<models::BaseItemDto>, Error<GetAncestorsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_critic_reviews(
    configuration: &configuration::Configuration,
    item_id: &str,
) -> Result<models::BaseItemDtoQueryResult, Error<GetCriticReviewsError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::ItemCounts, Error<GetItemCountsError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::LibraryOptionsResultDto, Error<GetLibraryOptionsInfoError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::BaseItemDtoQueryResult, Error<GetMediaFoldersError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::BaseItemDtoQueryResult, Error<GetSimilarAlbumsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_similar_artists(
    ...
    limit: Option<i32>,
    fields: Option<Vec<models::ItemFields>>,
) -> Result<models::BaseItemDtoQueryResult, Error<GetSimilarArtistsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_similar_items(
    ...
    limit: Option<i32>,
    fields: Option<Vec<models::ItemFields>>,
) -> Result<models::BaseItemDtoQueryResult, Error<GetSimilarItemsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_similar_movies(
    ...
    limit: Option<i32>,
    fields: Option<Vec<models::ItemFields>>,
) -> Result<models::BaseItemDtoQueryResult, Error<GetSimilarMoviesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_similar_shows(
    ...
    limit: Option<i32>,
    fields: Option<Vec<models::ItemFields>>,
) -> Result<models::BaseItemDtoQueryResult, Error<GetSimilarShowsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_similar_trailers(
    ...
    limit: Option<i32>,
    fields: Option<Vec<models::ItemFields>>,
) -> Result<models::BaseItemDtoQueryResult, Error<GetSimilarTrailersError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::AllThemeMediaResult, Error<GetThemeMediaError>> {
    let local_var_configuration = configuration;
...
pub async fn get_theme_songs(
    ...
    user_id: Option<&str>,
    inherit_from_parent: Option<bool>,
) -> Result<models::ThemeMediaResult, Error<GetThemeSongsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_theme_videos(
    ...
    user_id: Option<&str>,
    inherit_from_parent: Option<bool>,
) -> Result<models::ThemeMediaResult, Error<GetThemeVideosError>> {
    let local_var_configuration = configuration;
...
pub async fn post_updated_media(
    configuration: &configuration::Configuration,
    media_update_info_dto: models::MediaUpdateInfoDto,
