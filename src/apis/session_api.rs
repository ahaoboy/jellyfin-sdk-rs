...
pub async fn get_auth_providers(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::NameIdPair>, Error<GetAuthProvidersError>> {
    let local_var_configuration = configuration;
...
pub async fn get_password_reset_providers(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::NameIdPair>, Error<GetPasswordResetProvidersError>> {
    let local_var_configuration = configuration;
...
) -> Result<Vec<models::SessionInfo>, Error<GetSessionsError>> {
    let local_var_configuration = configuration;
...
pub async fn play(
    configuration: &configuration::Configuration,
    session_id: &str,
    play_command: models::PlayCommand,
...
pub async fn post_capabilities(
    ...
    supported_commands: Option<Vec<models::GeneralCommandType>>,
...
pub async fn post_full_capabilities(
    configuration: &configuration::Configuration,
    client_capabilities_dto: models::ClientCapabilitiesDto,
    id: Option<&str>,
...
pub async fn send_full_general_command(
    configuration: &configuration::Configuration,
    session_id: &str,
    general_command: models::GeneralCommand,
...
pub async fn send_general_command(
    configuration: &configuration::Configuration,
    session_id: &str,
    command: models::GeneralCommandType,
...
pub async fn send_message_command(
    configuration: &configuration::Configuration,
    session_id: &str,
    message_command: models::MessageCommand,
...
pub async fn send_playstate_command(
    configuration: &configuration::Configuration,
    session_id: &str,
    command: models::PlaystateCommand,
