...
) -> Result<models::BaseItemDtoQueryResult, Error<GetAlbumArtistsError>> {
...
pub async fn get_artist_by_name(
    ...
    name: &str,
    user_id: Option<&str>,
) -> Result<models::BaseItemDto, Error<GetArtistByNameError>> {
    let local_var_configuration = configuration;
...
pub async fn get_artists(
    ...
    enable_images: Option<bool>,
    enable_total_record_count: Option<bool>,
) -> Result<models::BaseItemDtoQueryResult, Error<GetArtistsError>> {
    let local_var_configuration = configuration;
