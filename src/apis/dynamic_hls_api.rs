...
pub async fn get_hls_audio_segment(
    ...
    subtitle_method: Option<models::SubtitleDeliveryMethod>,
    ...
    context: Option<models::EncodingContext>,
    ...
    if let Some(ref local_var_str) = r#static {
        local_var_req_builder =
            local_var_req_builder.query(&[("static", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = params {
        local_var_req_builder =
            local_var_req_builder.query(&[("params", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = device_profile_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("deviceProfileId", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = segment_container {
        local_var_req_builder =
            local_var_req_builder.query(&[("segmentContainer", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = segment_length {
        local_var_req_builder =
            local_var_req_builder.query(&[("segmentLength", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = min_segments {
        local_var_req_builder =
            local_var_req_builder.query(&[("minSegments", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = enable_auto_stream_copy {
        local_var_req_builder =
            local_var_req_builder.query(&[("enableAutoStreamCopy", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = audio_sample_rate {
        local_var_req_builder =
            local_var_req_builder.query(&[("audioSampleRate", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = audio_channels {
        local_var_req_builder =
            local_var_req_builder.query(&[("audioChannels", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = framerate {
        local_var_req_builder =
            local_var_req_builder.query(&[("framerate", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = max_framerate {
        local_var_req_builder =
            local_var_req_builder.query(&[("maxFramerate", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = video_bit_rate {
        local_var_req_builder =
            local_var_req_builder.query(&[("videoBitRate", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = subtitle_method {
        local_var_req_builder =
            local_var_req_builder.query(&[("subtitleMethod", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = max_ref_frames {
        local_var_req_builder =
            local_var_req_builder.query(&[("maxRefFrames", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = max_video_bit_depth {
        local_var_req_builder =
            local_var_req_builder.query(&[("maxVideoBitDepth", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = require_avc {
        local_var_req_builder =
            local_var_req_builder.query(&[("requireAvc", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = de_interlace {
        local_var_req_builder =
            local_var_req_builder.query(&[("deInterlace", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = require_non_anamorphic {
        local_var_req_builder =
            local_var_req_builder.query(&[("requireNonAnamorphic", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = transcoding_max_audio_channels {
        local_var_req_builder = local_var_req_builder
            .query(&[("transcodingMaxAudioChannels", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = cpu_core_limit {
        local_var_req_builder =
            local_var_req_builder.query(&[("cpuCoreLimit", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = enable_mpegts_m2_ts_mode {
        local_var_req_builder =
            local_var_req_builder.query(&[("enableMpegtsM2TsMode", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = video_codec {
        local_var_req_builder =
            local_var_req_builder.query(&[("videoCodec", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = subtitle_codec {
        local_var_req_builder =
            local_var_req_builder.query(&[("subtitleCodec", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = transcode_reasons {
        local_var_req_builder =
            local_var_req_builder.query(&[("transcodeReasons", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = video_stream_index {
        local_var_req_builder =
            local_var_req_builder.query(&[("videoStreamIndex", &local_var_str.to_string())]);
    }
...
pub async fn get_live_hls_stream(
    ...
    if let Some(ref local_var_str) = enable_subtitles_in_manifest {
        local_var_req_builder = local_var_req_builder
            .query(&[("enableSubtitlesInManifest", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
pub async fn get_master_hls_audio_playlist(
    ...
    if let Some(ref local_var_str) = enable_adaptive_bitrate_streaming {
        local_var_req_builder = local_var_req_builder
            .query(&[("enableAdaptiveBitrateStreaming", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
