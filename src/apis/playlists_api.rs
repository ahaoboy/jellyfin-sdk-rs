...
pub async fn create_playlist(
    ...
    create_playlist_dto: Option<models::CreatePlaylistDto>,
) -> Result<models::PlaylistCreationResult, Error<CreatePlaylistError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::BaseItemDtoQueryResult, Error<GetPlaylistItemsError>> {
    let local_var_configuration = configuration;
