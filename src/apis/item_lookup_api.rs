...
pub async fn apply_search_criteria(
    ...
    item_id: &str,
    remote_search_result: models::RemoteSearchResult,
...
pub async fn get_book_remote_search_results(
    configuration: &configuration::Configuration,
    book_info_remote_search_query: models::BookInfoRemoteSearchQuery,
) -> Result<Vec<models::RemoteSearchResult>, Error<GetBookRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_box_set_remote_search_results(
    configuration: &configuration::Configuration,
    box_set_info_remote_search_query: models::BoxSetInfoRemoteSearchQuery,
) -> Result<Vec<models::RemoteSearchResult>, Error<GetBoxSetRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_external_id_infos(
    configuration: &configuration::Configuration,
    item_id: &str,
) -> Result<Vec<models::ExternalIdInfo>, Error<GetExternalIdInfosError>> {
    let local_var_configuration = configuration;
...
pub async fn get_movie_remote_search_results(
    configuration: &configuration::Configuration,
    movie_info_remote_search_query: models::MovieInfoRemoteSearchQuery,
) -> Result<Vec<models::RemoteSearchResult>, Error<GetMovieRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_music_album_remote_search_results(
    configuration: &configuration::Configuration,
    album_info_remote_search_query: models::AlbumInfoRemoteSearchQuery,
) -> Result<Vec<models::RemoteSearchResult>, Error<GetMusicAlbumRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_music_artist_remote_search_results(
    configuration: &configuration::Configuration,
    artist_info_remote_search_query: models::ArtistInfoRemoteSearchQuery,
) -> Result<Vec<models::RemoteSearchResult>, Error<GetMusicArtistRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_music_video_remote_search_results(
    configuration: &configuration::Configuration,
    music_video_info_remote_search_query: models::MusicVideoInfoRemoteSearchQuery,
) -> Result<Vec<models::RemoteSearchResult>, Error<GetMusicVideoRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_person_remote_search_results(
    configuration: &configuration::Configuration,
    person_lookup_info_remote_search_query: models::PersonLookupInfoRemoteSearchQuery,
) -> Result<Vec<models::RemoteSearchResult>, Error<GetPersonRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_series_remote_search_results(
    configuration: &configuration::Configuration,
    series_info_remote_search_query: models::SeriesInfoRemoteSearchQuery,
) -> Result<Vec<models::RemoteSearchResult>, Error<GetSeriesRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_trailer_remote_search_results(
    configuration: &configuration::Configuration,
    trailer_info_remote_search_query: models::TrailerInfoRemoteSearchQuery,
) -> Result<Vec<models::RemoteSearchResult>, Error<GetTrailerRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
