...
pub async fn add_listing_provider(
    ...
    listings_provider_info: Option<models::ListingsProviderInfo>,
) -> Result<models::ListingsProviderInfo, Error<AddListingProviderError>> {
...
pub async fn add_tuner_host(
    configuration: &configuration::Configuration,
    tuner_host_info: Option<models::TunerHostInfo>,
) -> Result<models::TunerHostInfo, Error<AddTunerHostError>> {
    let local_var_configuration = configuration;
...
pub async fn create_series_timer(
    configuration: &configuration::Configuration,
    series_timer_info_dto: Option<models::SeriesTimerInfoDto>,
...
pub async fn create_timer(
    configuration: &configuration::Configuration,
    timer_info_dto: Option<models::TimerInfoDto>,
...
) -> Result<Vec<models::TunerHostInfo>, Error<DiscoverTunersError>> {
    let local_var_configuration = configuration;
...
pub async fn discvover_tuners(
    configuration: &configuration::Configuration,
    new_devices_only: Option<bool>,
) -> Result<Vec<models::TunerHostInfo>, Error<DiscvoverTunersError>> {
    let local_var_configuration = configuration;
...
pub async fn get_channel(
    ...
    channel_id: &str,
    user_id: Option<&str>,
) -> Result<models::BaseItemDto, Error<GetChannelError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::ChannelMappingOptionsDto, Error<GetChannelMappingOptionsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_default_listing_provider(
    configuration: &configuration::Configuration,
) -> Result<models::ListingsProviderInfo, Error<GetDefaultListingProviderError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::SeriesTimerInfoDto, Error<GetDefaultTimerError>> {
    let local_var_configuration = configuration;
...
pub async fn get_guide_info(
    configuration: &configuration::Configuration,
) -> Result<models::GuideInfo, Error<GetGuideInfoError>> {
    let local_var_configuration = configuration;
...
pub async fn get_lineups(
    ...
    location: Option<&str>,
    country: Option<&str>,
) -> Result<Vec<models::NameIdPair>, Error<GetLineupsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_live_tv_channels(
    configuration: &configuration::Configuration,
    r#type: Option<models::ChannelType>,
    user_id: Option<&str>,
...
) -> Result<models::BaseItemDtoQueryResult, Error<GetLiveTvChannelsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_live_tv_info(
    configuration: &configuration::Configuration,
) -> Result<models::LiveTvInfo, Error<GetLiveTvInfoError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::BaseItemDtoQueryResult, Error<GetLiveTvProgramsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_program(
    ...
    program_id: &str,
    user_id: Option<&str>,
) -> Result<models::BaseItemDto, Error<GetProgramError>> {
    let local_var_configuration = configuration;
...
pub async fn get_programs(
    configuration: &configuration::Configuration,
    get_programs_dto: Option<models::GetProgramsDto>,
) -> Result<models::BaseItemDtoQueryResult, Error<GetProgramsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_recommended_programs(
    ...
    enable_user_data: Option<bool>,
    enable_total_record_count: Option<bool>,
) -> Result<models::BaseItemDtoQueryResult, Error<GetRecommendedProgramsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_recording(
    ...
    recording_id: &str,
    user_id: Option<&str>,
) -> Result<models::BaseItemDto, Error<GetRecordingError>> {
    let local_var_configuration = configuration;
...
pub async fn get_recording_folders(
    configuration: &configuration::Configuration,
    user_id: Option<&str>,
) -> Result<models::BaseItemDtoQueryResult, Error<GetRecordingFoldersError>> {
    let local_var_configuration = configuration;
...
pub async fn get_recording_groups(
    configuration: &configuration::Configuration,
    user_id: Option<&str>,
) -> Result<models::BaseItemDtoQueryResult, Error<GetRecordingGroupsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_recordings(
    ...
    start_index: Option<i32>,
    limit: Option<i32>,
    status: Option<models::RecordingStatus>,
    ...
    enable_total_record_count: Option<bool>,
) -> Result<models::BaseItemDtoQueryResult, Error<GetRecordingsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_recordings_series(
    ...
    enable_user_data: Option<bool>,
    enable_total_record_count: Option<bool>,
) -> Result<models::BaseItemDtoQueryResult, Error<GetRecordingsSeriesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_series_timer(
    configuration: &configuration::Configuration,
    timer_id: &str,
) -> Result<models::SeriesTimerInfoDto, Error<GetSeriesTimerError>> {
    let local_var_configuration = configuration;
...
pub async fn get_series_timers(
    ...
    sort_by: Option<&str>,
    sort_order: Option<models::SortOrder>,
) -> Result<models::SeriesTimerInfoDtoQueryResult, Error<GetSeriesTimersError>> {
    let local_var_configuration = configuration;
...
pub async fn get_timer(
    configuration: &configuration::Configuration,
    timer_id: &str,
) -> Result<models::TimerInfoDto, Error<GetTimerError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::TimerInfoDtoQueryResult, Error<GetTimersError>> {
    let local_var_configuration = configuration;
...
pub async fn get_tuner_host_types(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::NameIdPair>, Error<GetTunerHostTypesError>> {
    let local_var_configuration = configuration;
...
pub async fn set_channel_mapping(
    configuration: &configuration::Configuration,
    set_channel_mapping_dto: models::SetChannelMappingDto,
) -> Result<models::TunerChannelMapping, Error<SetChannelMappingError>> {
    let local_var_configuration = configuration;
