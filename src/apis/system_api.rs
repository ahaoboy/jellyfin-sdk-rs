...
) -> Result<models::EndPointInfo, Error<GetEndpointInfoError>> {
...
pub async fn get_public_system_info(
    configuration: &configuration::Configuration,
) -> Result<models::PublicSystemInfo, Error<GetPublicSystemInfoError>> {
    let local_var_configuration = configuration;
...
pub async fn get_server_logs(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::LogFile>, Error<GetServerLogsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_system_info(
    configuration: &configuration::Configuration,
) -> Result<models::SystemInfo, Error<GetSystemInfoError>> {
    let local_var_configuration = configuration;
...
pub async fn get_wake_on_lan_info(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::WakeOnLanInfo>, Error<GetWakeOnLanInfoError>> {
    let local_var_configuration = configuration;
