...
pub async fn get_episodes(
    ...
    sort_by: Option<&str>,
) -> Result<models::BaseItemDtoQueryResult, Error<GetEpisodesError>> {
...
) -> Result<models::BaseItemDtoQueryResult, Error<GetNextUpError>> {
    let local_var_configuration = configuration;
...
pub async fn get_seasons(
    ...
    enable_image_types: Option<Vec<models::ImageType>>,
    enable_user_data: Option<bool>,
) -> Result<models::BaseItemDtoQueryResult, Error<GetSeasonsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_upcoming_episodes(
    ...
    enable_image_types: Option<Vec<models::ImageType>>,
    enable_user_data: Option<bool>,
) -> Result<models::BaseItemDtoQueryResult, Error<GetUpcomingEpisodesError>> {
    let local_var_configuration = configuration;
