...
) -> Result<models::ServerConfiguration, Error<GetConfigurationError>> {
...
pub async fn get_default_metadata_options(
    configuration: &configuration::Configuration,
) -> Result<models::MetadataOptions, Error<GetDefaultMetadataOptionsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_media_encoder_path(
    configuration: &configuration::Configuration,
    media_encoder_path_dto: models::MediaEncoderPathDto,
