...
pub async fn sync_play_buffering(
    ...
    buffer_request_dto: models::BufferRequestDto,
...
pub async fn sync_play_create_group(
    configuration: &configuration::Configuration,
    new_group_request_dto: models::NewGroupRequestDto,
...
pub async fn sync_play_get_groups(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::GroupInfoDto>, Error<SyncPlayGetGroupsError>> {
    let local_var_configuration = configuration;
...
pub async fn sync_play_join_group(
    configuration: &configuration::Configuration,
    join_group_request_dto: models::JoinGroupRequestDto,
...
pub async fn sync_play_move_playlist_item(
    configuration: &configuration::Configuration,
    move_playlist_item_request_dto: models::MovePlaylistItemRequestDto,
...
pub async fn sync_play_next_item(
    configuration: &configuration::Configuration,
    next_item_request_dto: models::NextItemRequestDto,
...
pub async fn sync_play_ping(
    configuration: &configuration::Configuration,
    ping_request_dto: models::PingRequestDto,
...
pub async fn sync_play_previous_item(
    configuration: &configuration::Configuration,
    previous_item_request_dto: models::PreviousItemRequestDto,
...
pub async fn sync_play_queue(
    configuration: &configuration::Configuration,
    queue_request_dto: models::QueueRequestDto,
...
pub async fn sync_play_ready(
    configuration: &configuration::Configuration,
    ready_request_dto: models::ReadyRequestDto,
...
pub async fn sync_play_remove_from_playlist(
    configuration: &configuration::Configuration,
    remove_from_playlist_request_dto: models::RemoveFromPlaylistRequestDto,
...
pub async fn sync_play_seek(
    configuration: &configuration::Configuration,
    seek_request_dto: models::SeekRequestDto,
...
pub async fn sync_play_set_ignore_wait(
    configuration: &configuration::Configuration,
    ignore_wait_request_dto: models::IgnoreWaitRequestDto,
...
pub async fn sync_play_set_new_queue(
    configuration: &configuration::Configuration,
    play_request_dto: models::PlayRequestDto,
...
pub async fn sync_play_set_playlist_item(
    configuration: &configuration::Configuration,
    set_playlist_item_request_dto: models::SetPlaylistItemRequestDto,
...
pub async fn sync_play_set_repeat_mode(
    configuration: &configuration::Configuration,
    set_repeat_mode_request_dto: models::SetRepeatModeRequestDto,
...
pub async fn sync_play_set_shuffle_mode(
    configuration: &configuration::Configuration,
    set_shuffle_mode_request_dto: models::SetShuffleModeRequestDto,
