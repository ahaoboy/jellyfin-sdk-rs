...
) -> Result<Vec<models::ChannelFeatures>, Error<GetAllChannelFeaturesError>> {
...
pub async fn get_channel_features(
    configuration: &configuration::Configuration,
    channel_id: &str,
) -> Result<models::ChannelFeatures, Error<GetChannelFeaturesError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::BaseItemDtoQueryResult, Error<GetChannelItemsError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::BaseItemDtoQueryResult, Error<GetChannelsError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::BaseItemDtoQueryResult, Error<GetLatestChannelItemsError>> {
    let local_var_configuration = configuration;
