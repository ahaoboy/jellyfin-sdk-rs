...
pub async fn get_playback_info(
    ...
    item_id: &str,
    user_id: &str,
) -> Result<models::PlaybackInfoResponse, Error<GetPlaybackInfoError>> {
    let local_var_configuration = configuration;
...
pub async fn get_posted_playback_info(
    ...
    playback_info_dto: Option<models::PlaybackInfoDto>,
) -> Result<models::PlaybackInfoResponse, Error<GetPostedPlaybackInfoError>> {
    let local_var_configuration = configuration;
...
pub async fn open_live_stream(
    ...
    enable_direct_play: Option<bool>,
    enable_direct_stream: Option<bool>,
    open_live_stream_dto: Option<models::OpenLiveStreamDto>,
) -> Result<models::LiveStreamResponse, Error<OpenLiveStreamError>> {
    let local_var_configuration = configuration;
