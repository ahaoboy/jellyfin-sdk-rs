...
pub struct BaseItemDto {
    ...
    pub play_access: Option<models::PlayAccess>,
    ...
    pub video_type: Option<models::VideoType>,
    ...
    pub iso_type: Option<models::IsoType>,
    ...
    pub image_orientation: Option<models::ImageOrientation>,
    #[serde(
        rename = "Aperture",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub channel_type: Option<models::ChannelType>,
    #[serde(rename = "Audio", skip_serializing_if = "Option::is_none")]
    pub audio: Option<models::ProgramAudio>,
