...
pub struct SessionInfo {
    ...
    pub full_now_playing_item: Option<Box<models::BaseItem>>,
    #[serde(rename = "NowViewingItem", skip_serializing_if = "Option::is_none")]
    pub now_viewing_item: Option<Box<models::BaseItemDto>>,
    ...
    pub supported_commands: Option<Option<Vec<models::GeneralCommandType>>>,
}
